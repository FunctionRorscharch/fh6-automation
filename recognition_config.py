...
DEFAULT_RECOGNITION_PROFILES = {
    ...
    "race.skillcar_like": {"timeout": 1.2, "interval": 0.25},
    ...
    "cj.buyandsell_landing": {"threshold": 0.70, "timeout": 15, "interval": 0.3, "fast_mode": False, "invert_mode": True},
    ...
    "cj.vehicle_menu": {"threshold": 0.68, "timeout": 12.0, "interval": 0.25, "fast_mode": False, "invert_mode": True},
    ...
    "cj.cls": {"threshold": 0.72, "timeout": 8, "interval": 0.25, "fast_mode": False},
